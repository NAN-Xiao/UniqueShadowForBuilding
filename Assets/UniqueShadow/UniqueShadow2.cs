...
public class UniqueShadow2: MonoBehaviour
{
    [System.Serializable]
    ...
    public static Texture2D ms_shadowTextureFakePoint;
    ...
    void SetFocus(int idx)
    {
        ...
        m_shadowMatrix = m_shadowSpaceMatrix * ortho * m_shadowCamera.worldToCameraMatrix;
