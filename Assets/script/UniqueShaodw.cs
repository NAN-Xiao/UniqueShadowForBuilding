...
public class UniqueShadow : MonoBehaviour
{
    ...
    //public
    public FilterType _ShadwoFilterType;
   ...
   // public int m_esmcount=8;
    ...
    void UpdateCamera()
    {
        ...
        if (m_shadowMap_final==null)
        {
            ...
            m_shadowMap_final.format = RenderTextureFormat.RGFloat;
    ...
    void SetUniforms()
    {
        for (int i = 0, n = m_mts.Count; i < n; ++i)
        {
            ...
            m.SetTexture(_UniqueShadowTexture, m_shadowMap_final);
...
//                : RenderTextureFormat.Depth;
            ...
            m_shadowMap_template = RenderTexture.GetTemporary(m_shadowMapSize, m_shadowMapSize, 32, RenderTextureFormat.Depth);
