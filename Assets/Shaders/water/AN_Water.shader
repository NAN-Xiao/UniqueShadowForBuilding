...
Shader "Faster/Terrain/CartoonWaterForDepth"
{
	Properties
	{
		...
		_Color2("Color 2", Color) = (0,0,0,0)
				_Color3("Color Base", Color) = (0,0,0,0)
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			if( eyeDepth337 > i.eyeDepth )
				...
				ifLocalVar336 = 0.0;
			float4 lerpResult342 = lerp(_Color1, screenColor274 , _Color3.a);
			...
			o.Albedo = ( lerpResult323 + Foam183 ).rgb*_Color3.rgb;
